...
While the BTC chain is downloading, it is a good idea to familiarize yourself with Haircomb's Usage Guidelines. Haircomb relies on building certain files that can be corrupted easily, if you are not careful. If you want to save yourself a headache, follow those guidelines very strictly.
